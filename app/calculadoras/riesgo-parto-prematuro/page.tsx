...
export default function RiesgoPartoPrematuroPage() {
  ...
  const calculateRisk = () => {
    ...
    if (factorCount >= 3) {
      return {
        ...
        recommendation: "Consulta con tu médico sobre medidas preventivas y monitoreo especial.",
      };
      ...
      return {
        ...
        recommendation: "Asiste a todos tus controles prenatales y reporta cualquier síntoma.",
      };
      ...
      return {
        ...
        recommendation: "Mantén tus controles prenatales y reporta cualquier síntoma inusual.",
      };
    } else {
      return {
        level: "Bajo",
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
            Calculadora de Riesgo de Parto Prematuro
          </h1>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                {[
                  { key: "previousPreterm", label: "Parto prematuro previo" },
                  { key: "multiplePregnancy", label: "Embarazo múltiple" },
                  { key: "infections", label: "Infecciones (urinarias, vaginales)" },
                  { key: "bleeding", label: "Hemorragia durante el embarazo" },
                  { key: "preeclampsia", label: "Preeclampsia" },
                  { key: "shortCervix", label: "Cuello uterino corto o incompetente" },
                  { key: "smoking", label: "Fumar o consumir drogas" },
                  { key: "stress", label: "Estrés extremo" },
                ].map((factor) => (
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800">
                        Si tienes contracciones antes de las 37 semanas, busca atención inmediata
                      </p>
                    </div>
                  </div>
